	...
	<form id="dataForm" method="post">
		...
		<div class="container col-xs-11"
				...
				<div class="col-xs-7">
					<div class="form-group">
						<input type="text" id="menuName" name="menuName"
							value="${menu.menuName}" class="form-control"
			...
			<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
				...
				<div class="col-xs-7">
					<div class="form-group">
						<input type="text" id="menuDescribe" name="menuDescribe"
							value="${menu.menuDescribe}" class="form-control"
				...
				<div class="col-xs-7">
					<div class="form-group">
						<input type="text" id="menuUrl" name="menuUrl"
							value="${menu.menuUrl}" class="form-control"
				...
				<div class="col-xs-7">
					<div class="form-group">
						<input type="text" id="menuIndex" name="menuIndex"
							value="${menu.menuIndex}" class="form-control"
			...
			<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
				...
				<div class="col-xs-7">
					<div class="form-group">
						...
						<c:if test="${menu.menuLevel != 1 && menu.menuLevel != 2 && menu.menuLevel != 3}">
							<button disabled="disabled" class="btn btn-info"><b>Level</b>
						</c:if>
							<span class="badge">${menu.menuLevel}</span>
						</button>
					</div>
				</div>
			</div>
			...
			<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
				...
				<div class="col-xs-7">
					<select id="menuValid" name="menuValid" class="selectpicker">
			...
			<div class="row" style="margin-top: 10px; margin-bottom: 10px;display: none;">
				...
				<input type="hidden" id="menuPid" name="menuPid" value="${menu.menuPid}" />
				<input type="hidden" id="menuLevel" name="menuLevel" value="${menu.menuLevel}" />
			</div>
		</div>
	</form>
</body>
<script type="text/javascript">
	$(function() {
		// 下拉框赋值
		$('#menuValid').selectpicker('val', '${menu.menuValid}');
		// 图标赋值
		...
		$('#save-btn').click(function() {
			...
			if (bv.isValid()) {
				...
				$.post('${pageContext.request.contextPath}/common/menu/save', formData, function(data) {
					if('0' == data.status){

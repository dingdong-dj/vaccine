...
<head>
    ...
    <title>免疫接种管理平台（${vaHosp.hospName}）</title>
    <style>
        /** skins **/
        #header {
            background: #4B96B4;
    ...
    <link rel="icon" href="../resources/images/logo.ico" type="img/x-ico"/>
</head>
<body>
...
<header id="header">
    <ul id="menu">
        ...
        <li id="logo" class="hidden-xs">
            <img src="${pageContext.request.contextPath}/resources/images/login_logo.png" style="width: 3em"/>
            <span id="system_title">免疫接种管理平台（${vaHosp.hospName}）</span>
        </li>
        <li class="pull-right">
            <ul class="hi-menu">
                <!-- 搜索 -->
...
<script type="text/javascript">
    ...
    function loadMenu(roleId) {
        ...
        $.post('${pageContext.request.contextPath}/' + roleId + '/menu', null, function (data) {
            ...
            menuHtml += "<li><div class='upms-version'>&copy; 免疫接种管理平台 V1.0</div></li>";

...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $table.bsTable({
            ...
            pageList: [10, 15, 20],
            //可供选择的每页的行数（*）
            url: '${pageContext.request.contextPath}/vaccine/register/list2N',
            // 请求后台的URL
            columns: [
                {
                    field: 'sysno',
            ...
            onDblClickRow: function (row) {
                index_Tab.addTab(row.patName + " - 登记记录", "vaccine/register/addOrEditPage2P?sysno=" + row.sysno);
            }
        });
    });
    ...
    function updateAction() {
        ...
        if (rows.length == 0) {
            ...
            index_Tab.addTab(rows[0].patName + " - 登记记录", "vaccine/register/addOrEditPage2N?sysno=" + rows[0].sysno);
        }
    }
